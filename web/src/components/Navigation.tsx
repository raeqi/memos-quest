import { BellIcon, BookOpenIcon, EarthIcon, LibraryIcon, PaperclipIcon, UserCircleIcon } from "lucide-react";
...
const Navigation = (props: Props) => {
  ...
  const storiesNavLink: NavLinkItem = {
    id: "header-stories",
    path: "/stories",
    title: t("travel-story.stories-title", "Stories"),
  ...
  const navLinks: NavLinkItem[] = currentUser
    ? [homeNavLink, exploreNavLink, storiesNavLink, attachmentsNavLink, inboxNavLink]
